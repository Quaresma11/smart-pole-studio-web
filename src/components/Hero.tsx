          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-300 max-w-lg">
                ...
                Развивайте силу, грацию и уверенность в себе вместе с нами!
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black px-8 py-4 rounded-lg font-bold text-lg hover:from-yellow-500 hover:to-yellow-600 transition-all transform hover:scale-105 shadow-lg">
