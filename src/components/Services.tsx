      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Выберите программу, которая подходит именно вам. От первых шагов в pole sport 
            до мастерского уровня — у нас есть всё для вашего развития
          </p>
        </div>
            ...
            <div key={index} className="bg-gray-900 rounded-xl overflow-hidden border border-yellow-400/20 hover:border-yellow-400/40 transition-all group hover:transform hover:scale-105">
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black px-4 py-2 rounded-lg font-semibold hover:from-yellow-500 hover:to-yellow-600 transition-all transform hover:scale-105">
                    Записаться
                  </button>
                </div>
              </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-yellow-400/10 to-yellow-600/5 p-8 rounded-2xl border border-yellow-400/20 max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Не знаете, с чего начать? Приходите на бесплатное пробное занятие! 
              Мы поможем определить ваш уровень и подберем подходящую программу.
            </p>
            <button className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black px-8 py-3 rounded-lg font-bold text-lg hover:from-yellow-500 hover:to-yellow-600 transition-all transform hover:scale-105">
