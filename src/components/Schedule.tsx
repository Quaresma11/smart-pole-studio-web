      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Удобное расписание с занятиями в разное время дня. 
            Выберите подходящее время и уровень сложности
          </p>
        </div>
        ...
        <div className="grid gap-4">
          {schedule[selectedDay as keyof typeof schedule].map((class_, index) => (
            <div key={index} className="bg-gray-900 rounded-xl p-6 border border-yellow-400/20 hover:border-yellow-400/40 transition-all">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-3">
                    <div className="bg-yellow-400 text-black px-3 py-1 rounded-lg font-bold text-lg">
                      {class_.time}
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black px-6 py-2 rounded-lg font-semibold hover:from-yellow-500 hover:to-yellow-600 transition-all transform hover:scale-105">
                    Записаться
                  </button>
